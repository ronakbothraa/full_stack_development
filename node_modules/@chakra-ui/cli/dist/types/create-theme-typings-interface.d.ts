...
export declare function createThemeTypingsInterface(theme: Record<string, unknown>, { config, strictComponentTypes, format, strictTokenTypes, template, }: CreateThemeTypingsInterfaceOptions): Promise<string>;
