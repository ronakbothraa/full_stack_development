...
import { generateThemeTypings } from './generate-theme-typings.mjs';
import { initCLI } from './utils/init-cli.mjs';
import { themeInterfaceDestination } from './resolve-output-path.mjs';

async function run() {
  await initCLI();
  program.command("tokens <source>").option(
    "--out <path>",
